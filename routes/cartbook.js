...
const { cartbook } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('cartbook');

// This file contains the logic of every route in Forest Admin for the collection cartbook:
...
// Create a Cartbook
router.post('/cartbook', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Cartbook
router.put('/cartbook/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Cartbook
router.delete('/cartbook/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Cartbooks
router.get('/cartbook', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Cartbooks
router.get('/cartbook/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Cartbook
router.get('/cartbook/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Cartbooks
router.get('/cartbook.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
