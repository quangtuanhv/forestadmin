...
const { userbooktransaction } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('userbooktransaction');

// This file contains the logic of every route in Forest Admin for the collection userbooktransaction:
...
// Create a Userbooktransaction
router.post('/userbooktransaction', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Userbooktransaction
router.put('/userbooktransaction/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Userbooktransaction
router.delete('/userbooktransaction/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Userbooktransactions
router.get('/userbooktransaction', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Userbooktransactions
router.get('/userbooktransaction/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Userbooktransaction
router.get('/userbooktransaction/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Userbooktransactions
router.get('/userbooktransaction.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
