...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('useraction');

// This file contains the logic of every route in Forest Admin for the collection useraction:
...
// Create a Useraction
router.post('/useraction', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Useraction
router.put('/useraction/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Useraction
router.delete('/useraction/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Useractions
router.get('/useraction', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Useractions
router.get('/useraction/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Useraction
router.get('/useraction/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Useractions
router.get('/useraction.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
