...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('archive');

// This file contains the logic of every route in Forest Admin for the collection archive:
...
// Create a Archive
router.post('/archive', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Archive
router.put('/archive/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Archive
router.delete('/archive/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/archive', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Archives
router.get('/archive/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Archive
router.get('/archive/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Archives
router.get('/archive.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
