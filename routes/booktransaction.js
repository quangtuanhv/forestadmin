...
const { booktransaction } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('booktransaction');

// This file contains the logic of every route in Forest Admin for the collection booktransaction:
...
router.post('/booktransaction', permissionMiddlewareCreator.create(), (request, response, next) => {
...
router.put('/booktransaction/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/booktransaction/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Booktransactions
router.get('/booktransaction', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Booktransactions
router.get('/booktransaction/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Booktransaction
router.get('/booktransaction/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Booktransactions
router.get('/booktransaction.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
