...
const { userbooknotification } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('userbooknotification');

// This file contains the logic of every route in Forest Admin for the collection userbooknotification:
...
// Create a Userbooknotification
router.post('/userbooknotification', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Userbooknotification
router.put('/userbooknotification/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Userbooknotification
router.delete('/userbooknotification/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Userbooknotifications
router.get('/userbooknotification', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Userbooknotifications
router.get('/userbooknotification/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Userbooknotification
router.get('/userbooknotification/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Userbooknotifications
router.get('/userbooknotification.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
