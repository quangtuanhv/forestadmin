...
const { genrepreference } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('genrepreference');

// This file contains the logic of every route in Forest Admin for the collection genrepreference:
...
router.post('/genrepreference', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Genrepreference
router.put('/genrepreference/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/genrepreference/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Genrepreferences
router.get('/genrepreference', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Genrepreferences
router.get('/genrepreference/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Genrepreference
router.get('/genrepreference/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Genrepreferences
router.get('/genrepreference.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
