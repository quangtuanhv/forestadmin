...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('transaction');

// This file contains the logic of every route in Forest Admin for the collection transaction:
...
router.post('/transaction', permissionMiddlewareCreator.create(), (request, response, next) => {
...
router.put('/transaction/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/transaction/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/transaction', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/transaction/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Transaction
router.get('/transaction/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/transaction.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
