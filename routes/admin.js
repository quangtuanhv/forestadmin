...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('admin');

// This file contains the logic of every route in Forest Admin for the collection admin:
...
// Create a Admin
router.post('/admin', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Admin
router.put('/admin/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Admin
router.delete('/admin/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/admin', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Admins
router.get('/admin/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Admin
router.get('/admin/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/admin.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
