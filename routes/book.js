...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('book');

// This file contains the logic of every route in Forest Admin for the collection book:
...
// Create a Book
router.post('/book', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Book
router.put('/book/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Book
router.delete('/book/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Books
router.get('/book', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/book/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Book
router.get('/book/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/book.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
