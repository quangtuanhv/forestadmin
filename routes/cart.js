...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('cart');

// This file contains the logic of every route in Forest Admin for the collection cart:
...
// Create a Cart
router.post('/cart', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Cart
router.put('/cart/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Cart
router.delete('/cart/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Carts
router.get('/cart', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Carts
router.get('/cart/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Cart
router.get('/cart/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Carts
router.get('/cart.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
