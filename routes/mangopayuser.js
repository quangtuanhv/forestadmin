...
const { mangopayuser } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('mangopayuser');

// This file contains the logic of every route in Forest Admin for the collection mangopayuser:
...
// Create a Mangopayuser
router.post('/mangopayuser', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Mangopayuser
router.put('/mangopayuser/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Mangopayuser
router.delete('/mangopayuser/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Mangopayusers
router.get('/mangopayuser', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Mangopayusers
router.get('/mangopayuser/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Mangopayuser
router.get('/mangopayuser/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Mangopayusers
router.get('/mangopayuser.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
